...
const LandingPage = () => {
  ...
  return (
    <div>
      <section className='flex flex-col items-center justify-center h-85 w-full bg-emerald-300 bg-[url(../../assets/imgs/pancake.png)] bg-[80px_center] bg-no-repeat bg-contain font-cursive '>
